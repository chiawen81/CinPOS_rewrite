    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Options", x => x.UniqueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProvideVersionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProvideVersionName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvideVersions", x => x.ProvideVersionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieProvideVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieProvideVersions_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieProvideVersions_ProvideVersions_ProvideVersionId",
                        column: x => x.ProvideVersionId,
                        principalTable: "ProvideVersions",
                        principalColumn: "ProvideVersionId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieProvideVersions_MovieId",
                table: "MovieProvideVersions",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieProvideVersions_ProvideVersionId",
                table: "MovieProvideVersions",
                column: "ProvideVersionId");
